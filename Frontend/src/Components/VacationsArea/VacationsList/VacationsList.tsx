...
function VacationsList(): JSX.Element {
  ...
  const [vacationsNotStart, setVacationsNotStart] = useState<VacationModel[]>(
    []
  ); // new array only not start
  ...
  useEffect(() => {
    if (!authService.isLoggedIn()) {
      ...
      const vacationsUnsubscribe = vacationsStore.subscribe(() => {
